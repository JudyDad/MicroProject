...
{
    public partial class Taxi_Visit3_Form : Form
    {
        public Taxi_Visit3_Form(MainForm mainForm)
        {
            InitializeComponent();
            this.mainForm = mainForm;
            this.V_ID = -1;
        }
        public Taxi_Visit3_Form(int V_ID,MainForm mainForm)
        {
            InitializeComponent();
            this.mainForm = mainForm;
            this.V_ID = V_ID;
        }
        public Taxi_Visit3_Form( MainForm mainForm, int MicroProject_ID)
        {
            InitializeComponent();
            this.mainForm = mainForm;
        ...
        private void Taxi_Visit3_Form_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void Visits_DataGridView_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                if (SelectedDataRow != null)
                {
                    ...
                    Form Evaluation_Form1 = new Evaluation_Form(Evaluation_ID, Beneficiary_ID,"T3", mainForm);
