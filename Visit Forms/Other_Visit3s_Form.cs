...
{
    public partial class Other_Visit3s_Form : Form
    {
        public Other_Visit3s_Form(MainForm mainForm)
        {
            InitializeComponent();
            this.mainForm = mainForm;
            this.V_ID = -1;
        }
        public Other_Visit3s_Form(int V_ID, MainForm mainForm)
        {
            InitializeComponent();
            this.mainForm = mainForm;
            this.V_ID = V_ID;
        }
        public Other_Visit3s_Form(MainForm mainForm, int MicroProject_ID)
        {
            InitializeComponent();
            this.mainForm = mainForm;
        ...
        private const string _KIND = "O3s";
        DataRow SelectedDataRow;
        int MicroProject_ID, V_ID, User_ID, Person_ID;
        ...
        private void Other_Visit3_Form_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                mainForm.TabName_label.Text = "Third Visit of Other Project";
        ...
        private void Visits_DataGridView_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                if (SelectedDataRow != null)
                {
                    ...
                    Form Evaluation_Form1 = new Evaluation_Form(Evaluation_ID, Beneficiary_ID, "O3s", mainForm);
        ...
        private void Delete_button_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dialogResult == DialogResult.Yes)
                {
                    ...
                    ///////////////////////////   Task IDs = 24   ////////////////////////////////////////////
                    TasksOfProjects = new TasksOfProjects();
                    TasksOfProjects.Update_Task_MicroProject(MicroProject_ID, 24, false, DateTime.Now);
                    //////////////////////////////////////////////////////////////////////////////////////////
