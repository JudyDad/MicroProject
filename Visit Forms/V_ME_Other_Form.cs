...
{
    public partial class V_ME_Other_Form : Form
    {
        private const string _KIND = "o";
        ...
        public V_ME_Other_Form(MainForm mainForm)
        {
            InitializeComponent();
        ...
        public V_ME_Other_Form(int V_ID, MainForm mainForm)
        {
            InitializeComponent();
            this.mainForm = mainForm;
            this.V_ID = V_ID;
        ...
        public V_ME_Other_Form(MainForm mainForm, string V_Num, string P_Name, int Partners)
        {
            InitializeComponent();
            this.mainForm = mainForm;
            this.P_Name = P_Name;
        ...
        private void Visit_O_Form_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                mainForm.TabName_label.Text = "Other Projects Visit";
        ...
        private void Save_button_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    //string VisitNumber = "Visit " + V_Num + "O";
        ...
        private void fill_visit_boxes(int V_ID)
        {
            try
            {
                ...
                if (dt != null)
                {
                    ...
                    //Fill visitors// 
                    V1_comboBox.Text = V2_comboBox.Text = V1_Eval_comboBox.Text = V2_Eval_comboBox.Text = "";
                    V1_comboBox.SelectedIndex = V2_comboBox.SelectedIndex =
                        V1_Eval_comboBox.SelectedIndex = V2_Eval_comboBox.SelectedIndex = -1;
