...
{
    public partial class Other_Visit3_Form : Form
    {
        public Other_Visit3_Form(MainForm mainForm)
        {
            InitializeComponent();
            this.mainForm = mainForm;
            this.V_ID = -1;
        }
        public Other_Visit3_Form(int V_ID,MainForm mainForm)
        {
            InitializeComponent();
            this.mainForm = mainForm;
            this.V_ID = V_ID;
        }
        public Other_Visit3_Form(MainForm mainForm, int MicroProject_ID)
        {
            InitializeComponent();
            this.mainForm = mainForm;
...
ELSE N'Success' End as 'التقييم'" +
        ...
        private void Visits_DataGridView_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                if (SelectedDataRow != null)
                {
                    ...
                    Form Evaluation_Form1 = new Evaluation_Form(Evaluation_ID, Beneficiary_ID, "O3", mainForm);
        ...
        private void clear_Visit_boxes(int j)
        {
            ...
            if (j != 0) {  MicroProject_ID_textBox1.Text = Person_Name_textBox1.Text = "";
                MicroProject_ID = -1;
            }
        }
