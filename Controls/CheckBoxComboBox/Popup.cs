...
namespace MyWorkApplication.Classes.CheckBoxComboBox
{
    ...
    public partial class Popup : ToolStripDropDown
    {
        ...
        ///     <see cref="M:System.Windows.Forms.Control.GetPreferredSize(System.Drawing.Size)" /> can specify.
        /// </summary>
        ...
        ///     <see cref="T:System.Windows.Forms.ToolStripDropDown" /> if the owner
        ///     <see cref="T:System.Windows.Forms.ToolStrip" /> is currently displayed, or clears and resets active
        ///     <see cref="T:System.Windows.Forms.ToolStripDropDown" /> child controls of the
        ///     <see cref="T:System.Windows.Forms.ToolStrip" /> if the <see cref="T:System.Windows.Forms.ToolStrip" /> is not
        ///     currently displayed.
        /// </summary>
        /// <param name="visible">
        ///     true if the owner <see cref="T:System.Windows.Forms.ToolStrip" /> is currently displayed;
        ///     otherwise, false.
        /// </param>
        protected override void SetVisibleCore(bool visible)
        {
            ...
            {
                if (i > 1) Thread.Sleep(frameduration);
        ...
        {
            if (ownerPopup != null) ownerPopup._resizable = false;
            if (FocusOnOpen) Content.Focus();
            base.OnOpened(e);
        }

        protected override void OnClosed(ToolStripDropDownClosedEventArgs e)
        {
            if (ownerPopup != null) ownerPopup._resizable = true;
            base.OnClosed(e);
        }
        ...
        private bool InternalProcessResizing(ref Message m, bool contentControl)
        {
            if (m.Msg == NativeMethods.WM_NCACTIVATE && m.WParam != IntPtr.Zero && childPopup != null &&
                childPopup.Visible) childPopup.Hide();
            if (!Resizable) return false;
            if (m.Msg == NativeMethods.WM_NCHITTEST)
                return OnNcHitTest(ref m, contentControl);
            if (m.Msg == NativeMethods.WM_GETMINMAXINFO) return OnGetMinMaxInfo(ref m);
            return false;
        }
        ...
        {
            if (e == null || e.Graphics == null || !resizable) return;
